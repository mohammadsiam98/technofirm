                            ...
                            <table id="html5-extension" class="table table-bordered non-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center badge rounded-pill badge-light-primary me-1" style="margin-top: 12px;">{{$blog_details_Fetch->get_category->categoryName}}</td>
                                        <td class="text-center" style="margin-top: 12px;">{{$blog_details_Fetch->get_user_name->name}}</td>
                                        <td class="text-center">{{$blog_details_Fetch->title}}</td>
                                       
                                        <td>
                                            <input type="checkbox" class="toggle-class" data-id="{{ $blog_details_Fetch->id }}" data-toggle="toggle" data-style="slow" data-on="Enabled" data-off="Disabled" {{ $blog_details_Fetch->status == true ? 'checked' : ''}}>
                                        </td>
                                        <td>
