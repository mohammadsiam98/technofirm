        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="bread-titlev2">
                    <h1 class="wow fadeInUp" data-wow-delay=".2s">Graphic Design Services</h1 </div>
                </div>
            </div>
        </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="single-image bg-shape-dez mt0 wow fadeIn">
                    <img src="{{asset('frontendAssets/assets/images/service/graphic-design.jpg')}}" alt="image" class="img-fluid no-shadow" />
                </div>
            </div>
            <div class="col-lg-8 block-1 m-mt50">
                <div class="common-heading text-l pl25">
                    ...
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                        ...
                        typesetting industry. Lorem Ipsum is simply dummy text of the printing and typesetting industry. is simply
        ...
        <div class="row upset link-hover">
            <div class="col-lg-6 col-md-12 mt30 wow fadeInUp" data-wow-delay=".2s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="{{asset('frontendAssets/assets/images/service/logo-design.jpg')}}" alt="service" class="img-fluid" />
                    </div>
            ...
            <div class="col-lg-6 col-md-12 mt30 wow fadeInUp" data-wow-delay=".4s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="{{asset('frontendAssets/assets/images/service/packaging-design.jpg')}}" alt="service" class="img-fluid" /></div>
                    <div class="s-block-content-large">
            ...
            <div class="col-lg-6 col-md-12 mt30 wow fadeInUp" data-wow-delay=".6s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="{{asset('frontendAssets/assets/images/service/brochure-.jpg')}}" alt="service" class="img-fluid" />
                    </div>
                    <div class="s-block-content-large">
            ...
            <div class="col-lg-6 col-md-12 mt30 wow fadeInUp" data-wow-delay=".8s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="{{asset('frontendAssets/assets/images/service/flyer-.html')}}" alt="service" class="img-fluid" />
                    </div>
                    <div class="s-block-content-large">
                        <h4>Flyer Design</h4>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy
            ...
            <div class="col-lg-6 col-md-12 mt30 wow fadeInUp" data-wow-delay="1s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="{{asset('frontendAssets/assets/images/service/newsletter.jpg')}}" alt="service" class="img-fluid" />
                    </div>
                    <div class="s-block-content-large">
            ...
            <div class="col-lg-6 col-md-12 mt30 wow fadeInUp" data-wow-delay="1.2s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="{{asset('frontendAssets/assets/images/service/visit-card.jpg')}}" alt="service" class="img-fluid" />
                    </div>
                    <div class="s-block-content-large">
