        ...
        <div class="content-header row">
            <div class="content-header-left col-md-12 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <a href="{{route('Contact.list')}}" class="actionButton">
                            ...
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{$contactDetails->number}}</td>
                                        <td class="text-center">{{$contactDetails->email}}</td>
                                        <td>

                                            <a href="{{ route('Contact.restoreData', $contactDetails->id) }}" style="padding: 10px">
                                            ...
                                            <a href="{{ route('Contact.forceDelete', $contactDetails->id) }}" style="color: red">
