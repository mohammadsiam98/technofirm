...
@section('content')
@section('title', 'Stack Details restoreLists')
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-12 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <a href="{{route('sector_technologies_details.create')}}" class="actionButton">
                        ...
                        <a href="{{route('sector_technologies_details.list')}}" class="actionButton">
                            <button type="button" class="btn btn-primary waves-effect waves-float waves-light" style="float: right">
                                <span style="font-size: 22px; margin-right:5px;">Sector Technology List</span>
                            ...
                            <table id="html5-extension" class="table table-bordered non-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img style="width: 150px; height:auto" src="{{ asset('images/SectorTechnologyImages/'.$stackDetailsFetch->created_at->format('Y/M/').'/'.$stackDetailsFetch->image) }}" alt="Sector Stack Details Images">
                                        </td>
                                        <td>
