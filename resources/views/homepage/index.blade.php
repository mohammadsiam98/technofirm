...
<section class="why-choos-lg-nx pad-tb deep-dark bg-gradient10">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                <div data-tilt data-tilt-max="5" data-tilt-speed="1000" class="single-image wow fadeIn" data-wow-duration="2s"><img src="images/Development-cuate.svg" alt="image" class="w-100"></div>

                <div data-tilt data-tilt-max="5" data-tilt-speed="1000" class="single-image wow fadeIn" data-wow-duration="2s"><img src="images/About us page-cuate.svg" alt="image" class="w-100"></div>
        ...
        <div class="row mt60">
            ...
            <div class="col-lg-12 col-sm-12 wptbb">
                <div class="pbwide shadow bg-gradient1">
                    <div class="portfolio-item-info-tt">
                        <div class="logowide mb20"><img src="images/client_image_ayeener_gurukul.png" style="height: 50px; width:auto" alt="logo" class="img-fluid"></div>
                        <div class="widebloktag"><span>Design</span> <span>Coding</span> </div>
                        <h3 class="mt30 mb30">Ayeener Gurukul</h3>
                        <ul class="info-list-ul">
                            <li><img src="images/check.png" alt=""> Able to create subject</li>
                            <li><img src="images/check.png" alt=""> Able to create exams</li>
                            <li><img src="images/check.png" alt=""> Able to create course</li>
                            <li><img src="images/check.png" alt=""> Enroll course</li>
                        </ul>
                    ...
                    <div class="portfolio-wide-image">
                        <div class="img-wide-blocktt tilt-outer">
                            <div class="innerwidedevice tilt-inner" data-tilt data-tilt-max="4" data-tilt-speed="1000" data-tilt-perspective="2000">
                                <div class="desktopblock shadow1"><img src="images/ayeenerGurukul.PNG" alt="img" class="img-fluid"> </div>
            ...
            <div class="col-lg-12 col-sm-12 wptbb">
                <div class="pbwide shadow bg-gradient2">
                    <div class="portfolio-item-info-tt">
                        <div class="logowide mb20"><img src="images/cityLawyers.png" alt="logo" style="height: 50px; width:auto" class="img-fluid"></div>
                        <div class="widebloktag"><span>Design</span> <span>Coding</span> </div>
                        <h3 class="mt30 mb30">City Lawyers</h3>
                        <ul class="info-list-ul">
                            <li><img src="images/check.png" alt=""> Portfolio Website</li>
                            <li><img src="images/check.png" alt=""> Able to show laws</li>
                        </ul>
                    ...
                    <div class="portfolio-wide-image">
                        <div class="img-wide-blocktt tilt-outer">
                            <div class="innerwidedevice tilt-inner" data-tilt data-tilt-max="4" data-tilt-speed="1000" data-tilt-perspective="2000">
                                <div class="desktopblock shadow1"><img src="images/citylaw.png" alt="img" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-12 col-sm-12 wptbb">
                <div class="pbwide shadow bg-gradient3">
                    <div class="portfolio-item-info-tt">
                        <div class="logowide mb20"><img src="images/client/customer-logo-7.png" style="height: 50px; width:auto" alt="logo" class="img-fluid"></div>
                        <div class="widebloktag"><span>Design</span> <span>Coding</span></div>
                        <h3 class="mt30 mb30">That Column</h3>
                        <ul class="info-list-ul">
                            <li><img src="images/check.png" alt=""> Able to upload blog</li>
                            <li><img src="images/check.png" alt=""> 15 blog features</li>
                            <li><img src="images/check.png" alt=""> users can upload blog</li>
                            <li><img src="images/check.png" alt=""> users can buy blogs</li>
                        </ul>
                    ...
                    <div class="portfolio-wide-image">
                        <div class="img-wide-blocktt tilt-outer">
                            <div class="innerwidedevice tilt-inner" data-tilt data-tilt-max="4" data-tilt-speed="1000" data-tilt-perspective="2000">
                                <div class="desktopblock shadow1"><img src="images/thatColumn.PNG" alt="img" class="img-fluid"> </div>
            ...
            <div class="col-lg-12 col-sm-12 wptbb">
                <div class="pbwide shadow bg-gradient4">
                    <div class="portfolio-item-info-tt">
                        <div class="logowide mb20"><img src="images/school.png" style="height: 50px; width:auto" alt="logo" class="img-fluid"></div>
                        <div class="widebloktag"><span>Design</span> <span>Coding</span></div>
                        <h3 class="mt30 mb30">River Dale School</h3>
                        <ul class="info-list-ul">
                            <li><img src="images/check.png" alt=""> School Information</li>
                            <li><img src="images/check.png" alt=""> Pay Online </li>
                            <li><img src="images/check.png" alt=""> Admission Information</li>
                            <li><img src="images/check.png" alt=""> Student's Syllabus</li>
                        </ul>
                    ...
                    <div class="portfolio-wide-image">
                        <div class="img-wide-blocktt tilt-outer">
                            <div class="innerwidedevice tilt-inner" data-tilt data-tilt-max="4" data-tilt-speed="1000" data-tilt-perspective="2000">
                                <div class="desktopblock shadow1"><img src="images/riverdaleSchool.PNG" alt="img" class="img-fluid"> </div>
            ...
            <div class="col-lg-12 col-sm-12 wptbb">
                <div class="pbwide shadow bg-gradient1">
                    <div class="portfolio-item-info-tt">
                        <div class="logowide mb20"><img src="images/bebshakoriLogo.png" style="height: 70px; width:auto" alt="logo" class="img-fluid"></div>
                        <div class="widebloktag"><span>Design</span> <span>Coding</span> </div>
                        <h3 class="mt30 mb30">Bebshakori</h3>
                        <ul class="info-list-ul">
                            <li><img src="images/check.png" alt=""> Business Listing</li>
                            <li><img src="images/check.png" alt=""> Pay Online</li>
                            <li><img src="images/check.png" alt=""> Membership</li>
                            <li><img src="images/check.png" alt=""> Live Location Track</li>
                        </ul>
                    </div>
                    <div class="portfolio-wide-image">
                        <div class="img-wide-blocktt tilt-outer">
                            <div class="innerwidedevice tilt-inner" data-tilt data-tilt-max="4" data-tilt-speed="1000" data-tilt-perspective="2000">
                                <div class="desktopblock shadow1"><img src="images/bebshakori.png" alt="img" class="img-fluid"> </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="clients-creative-pic pl25">
                    <img src="images/Customer Survey-pana.svg" alt="">
                </div>
            </div>
        </div>
    </div>
