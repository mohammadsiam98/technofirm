...
@section('content')
@section('title', 'Sector SF|Create')
        ...
        <div class="content-body">
            <section id="basic-horizontal-layouts">
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('SectorSF.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf                       
                                {{method_field('PUT')}}
                                <div class="row">
                                     {{-- Category List --}}
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="heading" class="form-control" name="heading" value="{{ (old('heading')?old('heading'):'') }}" placeholder="Write your special feature content heading" autocomplete="off" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="details" class="form-control" name="details" value="{{ (old('details')?old('details'):'') }}" placeholder="Write your details" autocomplete="off" />
                                            </div>
                                        </div>
                                    </div>
