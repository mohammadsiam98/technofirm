                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="Sector_technologies_name_heading" class="form-control" name="Sector_technologies_name_heading" value="{{$sector_Technology_head->Sector_technologies_name_heading}}" placeholder="Edit name" autocomplete="off" />
                                            </div>
                                        </div>
                                    </div>
