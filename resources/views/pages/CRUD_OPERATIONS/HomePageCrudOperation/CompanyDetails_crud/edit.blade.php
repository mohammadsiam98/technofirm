                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            <div class="col-sm-12">
                                                ...
                                                <textarea name="details" class="form-control" id="my_editor" aria-describedby="details" placeholder="Write your company description" id="" cols="30" rows="10">{!! $Details->details !!}</textarea>
                                            </div>
