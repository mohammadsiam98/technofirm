		...
		<div class="container-fluid m-pad">
								...
								<div class="sub-menu-section">
									<div class="sub-menu-center-block">
										<div class="sub-menu-column smfull">
											<ul>
												<li><a href="">
														<img src="{{asset('assets/images/development.png')}}" alt=""
															style="margin-right:10px;"> Web Development</a></li>
												<li><a href="">
														<img src="{{asset('assets/images/web-design.png')}}" alt=""
															style="margin-right:10px;"> Web Design</a></li>
												<li><a href="">
														<img src="{{asset('assets/images/graphic-design.png')}}" alt=""
															style="margin-right:10px;"> Graphics Design</a> </li>
												<li><a href="">
														<img src="{{asset('assets/images/mobile-app.png')}}" alt=""
															style="margin-right:13px;">App Development</a> </li>
												<li><a href="">
														<img src="{{asset('assets/images/edit-video.png')}}" alt=""
															style="margin-right:13px;">Video Editing</a> </li>
												<li><a href="">
														<img src="{{asset('assets/images/SEO.png')}}" alt=""
															style="margin-right:13px;">Search Engine Optimization</a>
												</li>
												<li><a href="">
														<img src="{{asset('assets/images/bullhorn.png')}}" alt=""
															style="margin-right:13px;">Social Media Marketing</a> </li>
												<li><a href="">
														<img src="{{asset('assets/images/creative-writing.png')}}"
															alt="" style="margin-right:10px;"> Content Writing</a> </li>
												<li><a href="">
														<img src="{{asset('assets/images/photography.png')}}" alt=""
															style="margin-right:13px;"> Photography</a> </li>
												<li><a href="">
														<img src="{{asset('assets/images/camera.png')}}" alt=""
															style="margin-right:13px;"> Cinematography</a> </li>
			...
			<nav id="main-nav">
				...
				<ul class="bottom-nav">
					...
					<li class="prb">
						<a
							href="https://separateweb.com/cdn-cgi/l/email-protection#32415d5f574557505f57565b5372555f535b5e1c515d5f">
				...
				<div class="col-lg-5 contact2dv">
					...
					<div class="info-wrapr">
						...
						<div class="dbox d-flex align-items-start">
							...
							<div class="text pl-4">
								<p><span>Email:</span> <a
										href="https://separateweb.com/cdn-cgi/l/email-protection#d1b8bfb7be91bfb8a6b0a9ffb2bebc"><span
											class="__cf_email__"
											data-cfemail="9bf2f5fdf4dbf5f2ecfae3b5f8f4f6">[email&#160;protected]</span></a>
								</p>
							</div>
						</div>
						<div class="dbox d-flex align-items-start">
...
<!-- Mirrored from separateweb.com/niwax-demo/get-quote-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Apr 2022 03:12:53 GMT -->
