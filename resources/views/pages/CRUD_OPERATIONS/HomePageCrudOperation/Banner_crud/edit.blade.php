                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="heading" class="form-control" name="heading" value="{{$banner->heading}}" value="{{ (old('heading')?old('heading'):'') }}" placeholder="Edit your banner header" autocomplete="off" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="subheading" class="form-control" name="subheading" value="{{$banner->subheading}}" value="{{ (old('subheading')?old('subheading'):'') }}" placeholder="Edit your banner subheader" autocomplete="off" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
