        ...
        <div class="content-body">
            <section id="basic-horizontal-layouts">
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            <form id="" action="{{route('Blogs.update',$blog_details->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    {{-- Category List --}}
                                        ...
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="category_id" class="select2 form-select" id="select2-basic">
                                                    ...
                                                    <option <?php if($category->id == $blog_details->category_id){?> selected <?php }  ?> value="{{ $category->id }}">{{ $category->categoryName }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="title" class="form-control" name="title" value="{{$blog_details->title}}" placeholder="Edit your blog title" autocomplete="off" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-1 row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea id="my-editor" name="description" class="form-control">{{$blog_details->description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
