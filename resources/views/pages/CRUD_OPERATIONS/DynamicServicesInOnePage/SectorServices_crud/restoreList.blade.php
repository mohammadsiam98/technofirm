        ...
        <div class="content-header row">
            <div class="content-header-left col-md-12 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <a href="{{route('SectorServices.create')}}" class="actionButton">
                        ...
                        <a href="{{route('SectorServices.list')}}" class="actionButton">
                    ...
                    <div class="card">
                        ...
                        <div class="widget-content widget-content-area br-6">
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($SectorServices as $key=>$SectorServicesDetails)
                                    <tr>
                                        <td class="checkbox-column text-center"> {{$key+1}} </td>
                                        <td class="text-center">{{$SectorServicesDetails->get_category->categoryName}}</td>
                                        <td class="text-center">  {{$SectorServicesDetails->get_service_name_heading->Sector_service_name}}</td>
                                        <td class="text-center">{{$SectorServicesDetails->title}}</td>
                                        <td>

                                            <a href="{{ route('SectorServices.restoreData', $SectorServicesDetails->id) }}" style="padding: 10px">
                                            ...
                                            <a href="{{ route('SectorServices.forceDelete', $SectorServicesDetails->id) }}" style="color: red">
