...
<!-- Mirrored from separateweb.com/niwax-demo/contact-from.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Apr 2022 03:13:10 GMT -->
      ...
      <div class="menu-header">
        ...
        <div class="custom-nav" role="navigation">
          <ul class="nav-list">
            ...
            <li class="sbmenu rpdropdown">
              <a href="#" class="menu-links">
                <img src="{{asset('assets/images/menu.png')}}" alt="" style="margin-right:10px;">
                Sectors</a>
                ...
                <div class="sub-menu-section">
                  <div class="sub-menu-center-block">
                    <div class="sub-menu-column smfull">
                      <ul>
                        <li><a href="">
                            <img src="{{asset('assets/images/development.png')}}" alt="" style="margin-right:10px;"> Web
                            Development</a></li>
                        <li><a href="">
                            <img src="{{asset('assets/images/web-design.png')}}" alt="" style="margin-right:10px;"> Web
                            Design</a></li>
                        <li><a href="">
                            <img src="{{asset('assets/images/graphic-design.png')}}" alt="" style="margin-right:10px;">
                            Graphics Design</a> </li>
                        <li><a href="">
                            <img src="{{asset('assets/images/mobile-app.png')}}" alt="" style="margin-right:13px;">App
                            Development</a> </li>
                        <li><a href="">
                            <img src="{{asset('assets/images/edit-video.png')}}" alt="" style="margin-right:13px;">Video
                            Editing</a> </li>
                        <li><a href="">
                            <img src="{{asset('assets/images/SEO.png')}}" alt="" style="margin-right:13px;">Search
                            Engine Optimization</a>
                        </li>
                        <li><a href="">
                            <img src="{{asset('assets/images/bullhorn.png')}}" alt="" style="margin-right:13px;">Social
                            Media Marketing</a> </li>
                        <li><a href="">
                            <img src="{{asset('assets/images/creative-writing.png')}}" alt=""
                              style="margin-right:10px;"> Content Writing</a> </li>
                        <li><a href="">
                            <img src="{{asset('assets/images/photography.png')}}" alt="" style="margin-right:13px;">
                            Photography</a> </li>
                        <li><a href="">
                            <img src="{{asset('assets/images/camera.png')}}" alt="" style="margin-right:13px;">
                            Cinematography</a> </li>
          ...
          <ul class="nav-list right-end-btn">
            ...
            <li class="hidemobile"><a href="get-quote.html" class="btn-br bg-btn3 btshad-b2 lnk">Project
                Proposal
                <span class="circle"></span></a> </li>
            <li class="hidedesktop darkmodeswitch">
              <div class="switch-wrapper"> <label class="switch" for="niwax"> <input type="checkbox" id="niwax" /> <span
                ...
                <form action="#" id="contactform" method="post">
                  <div class="fieldsets row">
                    <div class="col-md-6 form-group floating-label">
                      ...
                      <input type="text" placeholder=" " required="required" id="name" class="floating-input"
                        name="fullname">
                    ...
                    <div class="col-md-6 form-group floating-label">
                      ...
                      <input type="tel" placeholder=" " required="required" id="mobile_number" class="floating-input"
                        name="mobile_number">
                  ...
                  <div class="fieldsets row">
                    <div class="col-md-6 form-group floating-label">
                      ...
                      <input type="email" placeholder=" " required="required" id="email" class="floating-input"
                        name="email">
                  ...
                  <div class="fieldsets row textareax">
                    <div class="col-md-12 form-group floating-label">
                      ...
                      <textarea placeholder=" " required="required" id="description" class="floating-input"
                  ...
                  <div class="fieldsets mt20"> <button type="submit" name="submit"
                      class="btn btn-main bg-btn w-fit mb20"><span>Submit <i
